...
export default class TextUtil {
    ...
    static validateItemSearch(criterionName) {
        const unusableTerms = {
            ...
            'Quadro Pessoal': ['extra', 'receitas', 'empenho', 'despesas orcamentarias', 'qtd. de servidores', 'qtd. de servidores', 'outras despesas', 'receita', 'licitacao', 'licitacoes', 'demonstrativo', 'consultar restos a pagar']
