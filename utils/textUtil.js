...
export default class TextUtil {
    ...
    static validateItemSearch(criterionName) {
        const unusableTerms = {
            ...
            'Licitação': ['o que e uma licitacao?', 'artigo', 'receita', 'extra', 'extraorcamentarias', 'sagresonline.tce.pb.gov.br', 'contratos', 'receitas', 'despesa', 'despesas', 'receita', 'pessoal', 'folha de pagamento', 'demonstrativo', 'consultar restos a pagar'],
        ...
        const unusableCommumTerms = ["javascript", '...', 'cacimbadedentro', 'relatorio', 'clique aqui', 'caltodayclick', 'calfnyshuffle', 'gvfilterrowmenu', 'pdf', 'perguntas_frequentes', 'vlibras', "jaipt", '/jan/', '/fev/', '/mar/', '/abr/', '/maio/', '/jun/', '/jul/', '/jul/', '/ago/', '/set/'
