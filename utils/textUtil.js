...
export default class TextUtil {
    ...
    static validateItemSearch(criterionName) {
        ...
        const unusableCommumTerms = ["javascript", '...', 'dados de todos os orgaos do poder executivo', 'licitacoes.santarita.pb.gov.br/categoria/licitacoes' ,'acompanhe sua solicitacao', 'edital', 'imprimir', 'cacimbadedentro', 'relatorio', 'clique aqui', 'caltodayclick', 'calfnyshuffle', 'gvfilterrowmenu', 'pdf', 'perguntas_frequentes', 'vlibras', "jaipt", '/jan/', '/fev/', '/mar/', '/abr/', '/maio/', '/jun/', '/jul/', '/jul/', '/ago/', '/set/'
