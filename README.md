...
Da mesma forma os xpaths de busca por ***componentes dinâmicos clicáveis*** são criados para cada termo individualmente, aplicando-o a diversas tags e atributos consideradas relevante na descoberta deste tipo de componente durante observações nas estruturas HTML dos sites. Abaixo é exposto uma exemplificação deste tipo de xpath:
