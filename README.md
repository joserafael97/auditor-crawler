...
Todos os tipos de xpaths são criados por funções presentes na classe [xpathUtil.js](https://github.com/joserafael97/auditor-crawler/blob/master/utils/xpathUtil.js) presente no modulo ***util*** do projeto
