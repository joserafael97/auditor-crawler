const keywordSearchDespOrcamentaria = ['despesas', 'despesas orcamentaria', 'despesa com licitacao',
    'despesa por elemento', 'despesa por orgao', 'despesa por favorecido', 'despesa por funcional programatica', 'despesa por transferencia'
];
