...
const run = async () => {
    ...
    // evaluation.duration = evaluation.dateEnd.getTime() - initDate.getTime()
    // const delta = Math.abs(new Date() - initDate) / 1000;
    ...
    console.log((await Evaluation.findLastByCounty('Ouro Velho')));
};
